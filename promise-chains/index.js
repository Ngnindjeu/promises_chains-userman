 ...
 */
function performTaskOnUserAwait(userId) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    return [4 /*yield*/, performTaskOnUserAwait("4876")];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, performTaskOnUserAwait("5412")];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, performTaskOnUserAwait("0000")];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 4:
